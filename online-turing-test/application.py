...
conversation_config = [
    {
        "User": ["I'd love to get to know you better"],
        "AI": ["Me too"]
...
def generate_conversation_prompt(config):
    ...
    generated_prompt = "The following is a simulated conversation of a date between a man and a woman. The AI is fun, flirty, clever, and humorous woman. She loves to talk on end. She is similar in personality to Jennifer Lawrence.\n\n###\n\n"
    for r in config: 
        larger_num = max(len(r['User']), len(r['AI']))
